...
import cn.leiyy.modules.system.warpper.DictWarpper;
import cn.leiyy.common.persistence.dao.DictMapper;
import cn.leiyy.common.persistence.model.Dict;
...
public class DictController extends BaseController {
     ...
     */
    @BussinessLog(value = "添加字典记录", key = "dictName,dictValues", dict = cn.leiyy.common.constant.Dict.DictMap)
     ...
     * 修改字典
     */
    @BussinessLog(value = "修改字典", key = "dictName,dictValues", dict = cn.leiyy.common.constant.Dict.DictMap)
     ...
     * 删除字典记录
     */
    @BussinessLog(value = "删除字典记录", key = "dictId", dict = cn.leiyy.common.constant.Dict.DeleteDict)
