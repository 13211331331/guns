...
import com.stylefeng.guns.common.wechat.message.menu.*;
import com.stylefeng.guns.common.wechat.message.pojo.AccessToken;
...
public class MenuManager
{
    ...
    public static void main(String[] args) {
        ...
        if (null != at) {
            // 调用接口创建菜单
            String result = WeixinUtil.createMenu(getMenu(), at.getToken());
